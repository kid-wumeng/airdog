...
addService('_middleware.Send.@base')
addService('_middleware.BodyParser.JSON.@base')
addService('_middleware.BodyParser.Form.@base')
addService('_middleware.BodyParser.File.@base')
...
runSuite('Server.@base')
runSuite('Delegator.@base')
runSuite('Request.@base')
