...
test('Match by Normal-Path with method ALL', function(done)
{
  ...
  let r1 = new Route('/user/12/', new Middleware(fn1))
  let r2 = new Route('/user/12/', new Middleware(fn2))
  let r3 = new Route('/user/12/', new Middleware(fn3))
...
test('Match by Mixed-Path with method GET', function(done)
{
  ...
  let routeTable = new RouteTable
  let r1 = new Route('/src/:type/*/:name/', new Middleware(fn1))
  let r2 = new Route('/:dir/*/icon/:name/', new Middleware(fn2))
  let r3 = new Route('/res/:type/*/:name/', new Middleware(fn3))
