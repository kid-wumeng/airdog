 ...
 * @param  { String } path
 * @param  { Array < String > } statics - from the `app.config.static`
 * @return { boolean }
 */
...
exports.middleware = async function()
{
  ...
  let localPath, data, ext, type, isContinue = false
  
  localPath = await findLocalPath.call(this)
...
/**
* Find the localPath if exist
* @this { Context }
* @return { String | null } localPath
*/
