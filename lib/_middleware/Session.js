...
exports.appCreate = function(){
  this.app.session = this.app.session || {}
  this.app.session['store'] = new SessionStore(this.app)
}


exports.appClose = function(){
  this.app.session['store'].stopInspect()
}


exports.mid = async function(){
  let session = this.app.session['store'].get(this)
...
SessionStore.prototype.create = function(ctx){
  ...
  ctx.setCookie('Session-ID', sid, { httpOnly: true })
  return session
}
